    ...
    if command == 'update':
        ...
        if category == 'credits':
            ...
            if bindings['status'] == 0:
                logger.info('Dispenser: {} opened a dispenser for asset {} with {} balance, giving {} {} for each {} {}'.format(bindings['source'], bindings['asset'], bindings['escrow_quantity'], bindings['give_quantity'], bindings['asset'], bindings['satoshirate'], config.DOGE))
            elif bindings['status'] == 1:
                logger.info('Dispenser: {} (empty address) opened a dispenser for asset {} with {} balance, giving {} {} for each {} {}'.format(bindings['source'], bindings['asset'], bindings['escrow_quantity'], bindings['give_quantity'], bindings['asset'], bindings['satoshirate'], config.DOGE))
