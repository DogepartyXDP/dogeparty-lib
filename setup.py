...
class move_old_db(Command):
    ...
    def run(self):
        ...
        old_data_dir = appdirs.user_config_dir(appauthor='Dogeparty', appname='dogepartyd', roaming=True)
        ...
        new_data_dir = appdirs.user_data_dir(appauthor=config.XDP_NAME, appname=config.APP_NAME, roaming=True)
...
setup_options = {
    ...
    'author_email': 'dev@dogeparty.net',
    ...
    'download_url': 'https://github.com/DogepartyXDP/dogeparty-lib/releases/tag/' + CURRENT_VERSION,
